...
(function($){
	...
	$.fn.contactable = function(options) {
		//set default options  
		var defaults = {
			url: '/contactable/contactable/mail.php',
			name: 'Ваше ПІБ',
			email: 'Ваш E-mail',
			message : 'Повідомлення',
			subject : 'Лист з форми зворотнього звязку',
            page : location.href,
			submit : 'Надіслати звернення',
			recievedMsg : 'Дякую за Ваше звернення!',
			notRecievedMsg : 'Нажаль, при надсиланні звернення виникла помилка, спробуйте, будь ласка, ще раз',
			disclaimer: 'З радістю відповім на Ваше звернення',
			hideOnSubmit: true
